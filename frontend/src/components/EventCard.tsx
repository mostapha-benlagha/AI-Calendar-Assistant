...
export const EventCard: React.FC<EventCardProps> = ({ eventData }) => {
      ...
      <div className="event-card animate-scale-in">
        <div className="event-card-header">
          <div className="flex items-center gap-3">
            ...
            <h3 className="event-card-title text-lg sm:text-xl">
              Event Cancelled
            </h3>
          </div>
        </div>
          ...
          <div className="p-4 bg-accent-50/50 dark:bg-accent-900/20 rounded-xl border border-accent-200/50 dark:border-accent-700/50">
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-xl bg-accent-100 dark:bg-accent-800/50 flex items-center justify-center flex-shrink-0">
                <span className="text-accent-600 dark:text-accent-400 text-sm sm:text-base">
                  ✓
                </span>
              </div>
              <div>
                <h4 className="text-sm sm:text-base font-semibold text-accent-900 dark:text-accent-100 mb-1">
                  Cancellation Confirmed
                </h4>
                <p className="text-xs sm:text-sm text-accent-800 dark:text-accent-200">
                  The event has been successfully cancelled and removed from
                  your calendar.
                </p>
              </div>
            </div>
  ...
  return (
    <div className="event-card animate-scale-in">
      ...
      <div className="space-y-4">
        <div>
          <h4 className="font-bold text-slate-900 dark:text-slate-100 text-lg sm:text-xl mb-2">
            {event.summary}
          </h4>
          {event.description && (
        ...
        {event.attendees && event.attendees.length > 0 && (
          <div className="mt-4">
            <h5 className="text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">
              Attendees:
            </h5>
        ...
        {notes && (
          <div className="mt-6 p-3 sm:p-4 bg-info-50 dark:bg-info-900/20 rounded-2xl border border-info-200 dark:border-info-700">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="text-xs sm:text-sm font-semibold text-info-900 dark:text-info-100 mb-2">
                  Preparation Notes:
                </h5>
                <p className="text-xs sm:text-sm text-info-800 dark:text-info-200 whitespace-pre-wrap leading-relaxed">
                  {notes}
                </p>
              </div>
            </div>
